...
export const SECTION_TYPES_META: {
    type: SectionType; label: string; icon: string; desc: string; group: string;
        ...
        { type: 'callout', label: 'Callout', icon: '💬', desc: 'Tip / warning / info / danger', group: 'Bloques' },
        { type: 'image', label: 'Imagen', icon: '🖼', desc: 'Imagen con caption', group: 'Media' },
        { type: 'video', label: 'Video embed', icon: '▶', desc: 'URL YouTube / Vimeo', group: 'Media' },
